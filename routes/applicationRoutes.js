...
router.post('/submit', async (req, res) => {
  try {
    ...
    const adminPageUrl = process.env.ADMIN_PAGE_URL || 'http://localhost:3001'; // Default for safety

    // Send the confirmation emails
    await sendConfirmationEmails(savedApplication, adminPageUrl);
...
// --- ENDPOINT 2: DOWNLOAD THE PDF (FOR ADMIN PAGE) ---
router.get('/download-pdf/:id', async (req, res) => {
  try {
      ...
      <html>
        ...
        <body>
          ...
          <div class="section">
            ...
            <div classs="field"><strong>Advisory Services:</strong> ${application.advisoryServices}</div>
    ...
    // --- THIS IS THE FIX ---
    // We changed 'networkidle0' to 'load'
...
// --- ENDPOINT 3: GET ALL APPLICATIONS (FOR ADMIN PAGE) ---
